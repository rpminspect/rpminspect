...
unexpanded_enhances = "important-package >= 4.7.1-1%{_macro}"
...
class EnhancesCorrectRPMs(TestRPMs):
    ...
    def setUp(self):
        ...
        self.rpm.add_enhances(after_enhances)
...
class RetainingEnhancesRebaseCompareRPMs(TestCompareRPMs):
    ...
    def setUp(self):
        ...
        self.before_rpm.add_enhances(after_enhances)
...
class UnexpandedMacroEnhancesSRPM(TestSRPM):
    ...
    def setUp(self):
        ...
        self.rpm.add_enhances(unexpanded_enhances)
...
class UnexpandedMacroEnhancesCompareSRPM(TestCompareSRPM):
    ...
    def setUp(self):
        ...
        self.before_rpm.add_enhances(unexpanded_enhances)
        self.after_rpm.add_enhances(unexpanded_enhances)
...
class MultipleProvidersSRPM(TestSRPM):
    ...
    def setUp(self):
        ...
        self.rpm.add_enhances("vaporware-libs = %{version}-%{release}")
